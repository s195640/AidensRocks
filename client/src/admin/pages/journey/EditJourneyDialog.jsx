...
import styles from "./EditJourneyDialog.module.css";

const EditJourneyDialog = ({ post, onClose, onSave }) => {
  ...
  const toggleImageShow = async (rpi_key, currentShow) => {
    try {
      const res = await fetch(`/api/journey-admin/images/${rpi_key}/toggle-show`, {
        method: "POST",
  ...
  const handleAddImage = () => {
    alert("Add Image functionality not implemented yet.");
  };
  ...
  const getFullImageUrl = (img) =>
    `/media/rocks/${formData.rock_number}/${post.uuid}/webp/${img.current_name}.webp`;
              ...
              {images.map((img) => (
                <tr key={img.rpi_key}>
                  ...
                  <td className={styles.actionsCol}>
                    ...
                    <button onClick={() => deleteImage(img.rpi_key)} type="button">
                      Delete
                    </button>
                  </td>
                </tr>
